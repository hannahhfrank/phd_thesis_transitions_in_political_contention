...
df_protest = acled.loc[acled['event_type']=="Explosions/Remote violence"].copy(deep=True)
...
agg_month.columns = ["year","country","gw_codes","acled_codes","n_remote_events","fatalities"]

### Save data ---------
agg_month = agg_month.sort_values(by=["country","year"])
agg_month.reset_index(drop=True,inplace=True)
agg_month.to_csv("data_out/acled_cy_remote.csv",sep=',')
